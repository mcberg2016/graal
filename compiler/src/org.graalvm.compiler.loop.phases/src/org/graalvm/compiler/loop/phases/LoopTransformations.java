...
public abstract class LoopTransformations {
    ...
    public static boolean partialUnroll(LoopEx loop, StructuredGraph graph) {
        ...
        Debug.dump(Debug.VERBOSE_LEVEL, graph, "After duplication inside %s", mainLoopBegin);
    ...
    private static void placeNewSegmentAndCleanup(CountedLoopInfo mainCounted, LoopBeginNode mainLoopBegin, LoopFragmentInside newSegment) {
        ...
        if (codeInTrueSide) {
            ...
            Debug.dump(Debug.VERBOSE_LEVEL, mainLoopBegin.graph(), "before");
        ...
        Debug.dump(Debug.DETAILED_LEVEL, loopEndNode.graph(), "Before placing segment");
        ...
        Debug.dump(Debug.DETAILED_LEVEL, loopEndNode.graph(), "After placing segment");
    }
    ...
    public static void insertPrePostLoops(LoopEx loop, StructuredGraph graph) {
        Debug.log("LoopTransformations.insertPrePostLoops %s", loop);
        ...
        if (preLimit != null) {
            ...
            Debug.dump(Debug.VERBOSE_LEVEL, graph, "After duplication");
